...
void LookAndFeel::drawRotarySlider(juce::Graphics & grafikas,int x,int y,int width,int height,float sliderisFloat,float sakumaLenkis,float beiguLenkis,juce::Slider & slider)
{
    ...
    grafikas.setColour(enabled ? Colour(55u, 55u, 55u) : Colour(55u, 55u, 55u));
    grafikas.fillEllipse(bounds);
    
    grafikas.setColour(enabled ? Colour(255u, 154u, 1u) : Colour(55u, 55u, 55u));
    grafikas.drawEllipse(bounds, 1.f);
    ...
    if( auto* rswl = dynamic_cast<RotarySliderWithLabels*>(&slider))
    {
        ...
        jassert(sakumaLenkis < beiguLenkis);
        
        auto sliderAngRad = jmap(sliderisFloat, 0.f, 1.f, sakumaLenkis, beiguLenkis);
        
        p.applyTransform(AffineTransform().rotated(sliderAngRad, center.getX(), center.getY()));
        
        grafikas.fillPath(p);
        
        grafikas.setFont(rswl->getTextHeight());
        auto text = rswl->getDisplayString();
        auto strWidth = grafikas.getCurrentFont().getStringWidth(text);
        ...
        grafikas.setColour(enabled ? Colours::white : Colour(55u, 55u, 55u));
        grafikas.drawFittedText(text, r.toNearestInt(), juce::Justification::centred, 1);
    }
}

void LookAndFeel::drawToggleButton(juce::Graphics &g,
                                   juce::ToggleButton &togglePoga,
                                   bool pogasArHighlight,
                                   bool nospiestasPogas)
{
    using namespace juce;
    
    if( auto* pb = dynamic_cast<PowerButton*>(&togglePoga) )
    {
        Path powerButton;
        
        auto bounds = togglePoga.getLocalBounds();
        ...
        auto color = togglePoga.getToggleState() ? Colours::dimgrey : Colour(0u, 172u, 1u);
        
        g.setColour(color);
        g.strokePath(powerButton, pst);
        g.drawEllipse(r, 2);
    }
    else if( auto* analyzerButton = dynamic_cast<AnalyzerButton*>(&togglePoga) )
    {
        auto color = ! togglePoga.getToggleState() ? Colours::dimgrey : Colour(0u, 172u, 1u);
...
//    g.drawRect(sliderBounds);
    ...
    g.setColour(Colour(0u, 255u, 41u));
...
void ResponseCurveComponent::paint (juce::Graphics& g)
{
    ...
    if( shouldShowFFTAnalysis )
    {
        ...
        g.setColour(Colour(0u, 255u, 41u)); //zalais-
        g.strokePath(leftChannelFFTPath, PathStrokeType(1.f));
        
        auto rightChannelFFTPath = rightPathProducer.getPath();
        rightChannelFFTPath.applyTransform(AffineTransform().translation(responseArea.getX(), responseArea.getY()));
        
        g.setColour(Colour(55u, 55u, 55u));
...
void ResponseCurveComponent::drawBackgroundGrid(juce::Graphics &g)
{
    ...
    for( auto gDb : gain )
    {
        ...
        g.setColour(gDb == 0.f ? Colour(0u, 255u, 41u) : Colours::white );
...
void ResponseCurveComponent::drawTextLabels(juce::Graphics &g)
{
    ...
    for( auto gDb : gain )
    {
        ...
        g.setColour(gDb == 0.f ? Colour(55u, 55u, 55u) : Colour(55u, 55u, 5u));
...
void SimpleEQAudioProcessorEditor::paint(juce::Graphics &g)
{
    ...
    g.setFont(Font("Comic Sans MS", 30, 0)); 
